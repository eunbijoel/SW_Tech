...
### 5. 저장된 대화 & Step Flow
<img width="416" height="729" alt="image" src="https://github.com/user-attachments/assets/ed0792f3-1d41-4011-aef1-1a0f70c66b95" />
<img width="1455" height="736" alt="image" src="https://github.com/user-attachments/assets/5a6693eb-bbff-4250-9357-aabd6ab5ebde" />
...
## 변경 이력 (요약)
- **2026-05-26:** Persona 실행 파이프라인 (`src/`), Step Flow 순차 실행 (`step_flow_engine`), personas.json 확장, LLM `read_excel` 자동 보정
